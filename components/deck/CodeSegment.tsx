...
export function CodeSegment({
    ...
    return (
        <div className="px-3">
            <div className="relative group bg-[#0d1117] overflow-hidden">
                {/* Delete button */}
                <button
                    type="button"
                    onClick={() => deleteCodeBlock(index)}
                    className="absolute top-3 right-3 z-10 w-6 h-6 flex items-center justify-center bg-white/5 text-white/40 hover:text-white hover:bg-white/10 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all"
