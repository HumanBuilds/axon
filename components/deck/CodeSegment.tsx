        ...
        <div className="px-3">
            <div className="relative group bg-slate-50 overflow-hidden">
                ...
                <button
                    ...
                    className="absolute top-3 right-3 z-10 w-6 h-6 flex items-center justify-center bg-slate-200/50 text-slate-400 hover:text-slate-700 hover:bg-slate-200 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all"
