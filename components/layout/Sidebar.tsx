    ...
    return (
        <aside className="hidden lg:flex flex-col w-64 gap-6 shrink-0">
            <div className="flex flex-col gap-1">
                <p className="text-[10px] font-bold uppercase tracking-widest text-base-content/40 mb-2 px-3">
                    Library
                </p>
                <nav className="flex flex-col gap-1">
                    ...
                    <a
                        href="#"
                        className="flex items-center gap-3 px-3 py-2 text-base-content/60 hover:bg-base-200 transition-colors text-sm"
                    >
