...
export function Modal({
    ...
    return (
        <div
            className="fixed inset-0 z-50 flex items-center justify-center bg-base-content/60 backdrop-blur-sm p-4"
            onClick={onClose}
        >
            <div
                className={`w-full max-w-2xl bg-base-100 border-[3px] border-primary shadow-[8px_8px_0px_0px_rgba(50,17,212,0.2)] flex flex-col ${className ?? ''}`}
